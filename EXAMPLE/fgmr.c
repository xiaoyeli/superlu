 ...
 * \param [in] matvec    Operation for matrix-vector multiplication.
 * \param [in] psolve    (right) preconditioning operation. Can be a NULL pointer (GMRES without preconditioner)
