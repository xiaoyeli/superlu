 ...
 */
    ...
    extern int zgst01(int_t, int_t, SuperMatrix *, SuperMatrix *, 
    ...
    extern int sp_zconvert(int_t, int_t, doublecomplex *, int, int, int,
	...
	if ( imat ) {
	    ...
	    /* Set up parameters with ZLATB4 and generate a test matrix
	       with ZLATMS.  */
	    zlatb4_slu(path, &imat, (int*)&n, (int*)&n, sym, &kl, &ku, &anorm, &mode,
		    &cndnum, dist);

	    zlatms_slu((int*)&n, (int*)&n, dist, iseed, sym, &rwork[0], &mode, &cndnum,
